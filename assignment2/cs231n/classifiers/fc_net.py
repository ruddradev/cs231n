...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        hidden_score,cache1=affine_forward(X,self.params['W1'],self.params['b1'])
        scores_relu,cacheRelu=relu_forward(hidden_score)
        scores,cache2=affine_forward(scores_relu,self.params['W2'],self.params['b2'])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        grads['W2']=dw2
        grads['b2']=db2
        dxRelu=relu_backward(dx2,cacheRelu)
        dx1,dw1,db1=affine_backward(dxRelu,cache1)
        grads['W1']=dw1
        grads['b1']=db1
        ############################################################################
        #                             END OF YOUR CODE                             #
